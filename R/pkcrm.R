...
#' @export
pkcrm <-
function(y, auc, doses, x, theta, p0, L, prob = 0.9, options = list(nchains = 4, niter = 4000, nadapt = 0.8), betapriors = 10000, thetaL=NULL, deltaAUC = NULL){
    ...
    # For STAN
    data_s <- list(N=num, auc=log(auc), dose=dose1, beta0=betapriors)
