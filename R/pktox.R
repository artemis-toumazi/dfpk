...
#' @export pktox
pktox <-
function(y, auc, doses, x, theta, prob = 0.9, options = list(nchains = 4, niter = 4000, nadapt = 0.8), betapriors = c(10000, 20, 10), thetaL=NULL, p0=NULL, L=NULL, deltaAUC=NULL){
    ...
    # For STAN model
    data_s <- list(N=num, y=y, dose=auc1, beta2mean = betapriors[2], beta3mean = betapriors[3])
    ## auc1 is log(AUCs)
