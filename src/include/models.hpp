...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        validate_non_negative_index("bet", "2", 2);
        num_params_r__ += 2;
    }
        ...
        try {
            {
                ...
                lp_accum__.add(uniform_log<propto__>(get_base1(bet,1,"bet",1), stan::math::fmax(0.0,(beta0mean - 10)), (beta0mean + 10)));
                lp_accum__.add(uniform_log<propto__>(get_base1(bet,2,"bet",1), stan::math::fmax(0.0,(beta1mean - 5)), (beta1mean + 5)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        stan::math::initialize(bet1, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(bet1,DUMMY_VAR__);
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        stan::math::initialize(bet2, DUMMY_VAR__);
    ...
    void write_array(RNG& base_rng__,
        ...
        stan::math::initialize(bet2, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(bet2,DUMMY_VAR__);
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(b, mu, beta0));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
