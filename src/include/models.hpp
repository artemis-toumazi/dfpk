...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(22, 22, "end", "model_cdf_reg_dtox");
    return reader;
}
        ...
        try {
            {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::math::assign(get_base1_lhs(z,n,"z",1), (-(beta0) + (get_base1(dose,n,"dose",1) * beta1)));
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(22, 22, "end", "model_cdf_reg_pktox");
    return reader;
}
        ...
        try {
            {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::math::assign(get_base1_lhs(z,n,"z",1), (-(beta2) + (get_base1(dose,n,"dose",1) * beta3)));
                    stan::math::assign(get_base1_lhs(p,n,"p",1), normal_cdf(get_base1(z,n,"z",1),0,1));
                }
                lp_accum__.add(bernoulli_log<propto__>(y, p));
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(25, 25, "end", "model_logit_reg_pkcov");
    return reader;
}
        ...
        try {
            {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::math::assign(get_base1_lhs(z,n,"z",1), ((beta0 - (get_base1(dose,n,"dose",1) * beta1)) - (beta2 * get_base1(dauc,n,"dauc",1))));
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(22, 22, "end", "model_logit_reg_pklogit");
    return reader;
}
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(22, 22, "end", "model_logit_reg_pkpop");
    return reader;
}
        ...
        try {
            {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::math::assign(get_base1_lhs(z,n,"z",1), (beta3 - (get_base1(dose,n,"dose",1) * beta4)));
                    stan::math::assign(get_base1_lhs(p,n,"p",1), (1 / (1 + exp(get_base1(z,n,"z",1)))));
                }
                lp_accum__.add(bernoulli_log<propto__>(y, p));
                lp_accum__.add(uniform_log<propto__>(beta3, 0.0, beta3mean));
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(17, 17, "end", "model_reg_auc");
    return reader;
}
